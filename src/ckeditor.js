...
import CustomHeadings from "./ckeditor5-cheadings/heading";
import Infobox from "./ckeditor5-cinfobox/infobox";
import Codeblock from "./ckeditor5-ccodeblock/codeblock";
...
ClassicEditor.defaultConfig = {
    ...
    heading: {
        options: [
            {
                model: "paragraph",
                view: { name: 'p', classes: 'fire_paragraph' },
                title: "Paragraph",
                class: "ck-heading_paragraph",
            },
            {
                model: "heading1",
                view: { name: 'div', classes: 'fire_heading1' },
                title: "Heading 1",
                class: "ck-heading_heading1",
            },
            {
                model: "heading2",
                view: { name: 'div', classes: 'fire_heading2' },
                title: "Heading 2",
                class: "ck-heading_heading2",
            },
            {
                model: "heading3",
                view: { name: 'div', classes: 'fire_heading3' },
                title: "Heading 3",
